...
describe('Promise-specific extensions:', () => {
  ...
  describe('when the promise is fulfilled', () => {
    ...
    describe('.fulfilled passes the fulfilled value', () => {
      shouldPass(() =>
        promise.should.be.fulfilled.then((passedValue) => {
    ...
    describe('.not.rejected passes the fulfilled value', () => {
      shouldPass(() =>
        promise.should.not.be.rejected.then((passedValue) => {
          passedValue.should.equal(42);
        })
      );
    });
    ...
    describe('.not.rejectedWith(TypeError) passes the fulfilled value', () => {
      shouldPass(() =>
        promise.should.not.be.rejectedWith(TypeError).then((passedValue) => {
          passedValue.should.equal(42);
        })
      );
    });
    ...
    describe('.not.rejectedWith(TypeError) allows chaining', () => {
      shouldPass(() =>
        promise.should.not.be.rejectedWith(TypeError).and.eventually.equal(31)
      );
    });
    ...
    describe(".rejectedWith('message substring')", () => {
      shouldFail({
        ...
        message:
          "to be rejected with an error including 'message substring' but it was fulfilled with " +
          '42'
      });
    });
    describe('.rejectedWith(/regexp/)', () => {
      shouldFail({
        ...
        message:
          'to be rejected with an error matching /regexp/ but it was fulfilled with 42'
      });
    });
    describe(".rejectedWith(TypeError, 'message substring')", () => {
      shouldFail({
        op: () =>
          promise.should.be.rejectedWith(TypeError, 'message substring'),
        message: "to be rejected with 'TypeError' but it was fulfilled with 42"
      });
    });
    ...
    describe(".not.rejectedWith(TypeError, 'message substring')", () => {
      shouldPass(() =>
        promise.should.not.be.rejectedWith(TypeError, 'message substring')
      );
    });
  ...
  describe('when the promise is rejected', () => {
    ...
    describe('.not.fulfilled should allow chaining', () => {
      shouldPass(() =>
        promise.should.not.be.fulfilled.and.eventually.have.property(
          'nonexistent'
        )
      );
    });
    ...
    describe('.not.fulfilled should pass the rejection reason', () => {
      shouldPass(() =>
        promise.should.not.be.fulfilled.then((passedError) => {
    ...
    describe('.rejected should allow chaining', () => {
      shouldPass(() =>
        promise.should.be.rejected.and.eventually.have.property('myProp')
      );
    });

    describe('.rejected passes the rejection reason', () => {
      shouldPass(() =>
        promise.should.be.rejected.then((passedError) => {
          passedError.should.equal(error);
        })
      );
    });
    ...
    describe('.rejectedWith(theError) should allow chaining', () => {
      shouldPass(() =>
        promise.should.be
          .rejectedWith(error)
          .and.eventually.have.property('myProp')
      );
    });

    describe('.rejectedWith(theError) passes the rejection reason', () => {
      shouldPass(() =>
        promise.should.be.rejectedWith(error).then((passedError) => {
          passedError.should.equal(error);
        })
      );
    });
    ...
    describe('.rejectedWith(differentError)', () => {
      shouldFail({
        ...
        message:
          "to be rejected with 'Error' but it was rejected with 'Error: boo'"
      });
    });
    ...
    describe("with an Error having message 'foo bar'", () => {
      ...
      describe(".rejectedWith('quux')", () => {
        shouldFail({
          ...
          message:
            "to be rejected with an error including 'quux' but got 'foo bar'"
        });
      });
      ...
      describe('.rejectedWith(/quux/)', () => {
        shouldFail({
          op: () => promise.should.be.rejectedWith(/quux/),
          message:
            "to be rejected with an error matching /quux/ but got 'foo bar'"
        });
      });
    ...
    describe('with a RangeError', () => {
      ...
      describe('.not.rejectedWith(RangeError)', () => {
        shouldFail({
          ...
          message:
            "not to be rejected with 'RangeError' but it was rejected with 'RangeError'"
        });
      });
      ...
      describe('.rejectedWith(TypeError)', () => {
        shouldFail({
          op: () => promise.should.be.rejectedWith(TypeError),
          message:
            "to be rejected with 'TypeError' but it was rejected with 'RangeError'"
        });
      });
      ...
      describe('.rejectedWith(Array)', () => {
        shouldFail({
          ...
          message:
            "to be rejected with 'Array' but it was rejected with 'RangeError'"
        });
      });
    ...
    describe("with a RangeError having a message 'foo bar'", () => {
      ...
      describe(".not.rejectedWith(RangeError, 'foo')", () => {
        shouldFail({
          ...
          message:
            "not to be rejected with 'RangeError' but it was rejected with 'RangeError: foo bar'"
        });
      });
      ...
      describe(".rejectedWith(TypeError, 'foo')", () => {
        shouldFail({
          ...
          message:
            "to be rejected with 'TypeError' but it was rejected with 'RangeError: foo bar'"
        });
      });
      ...
      describe(".not.rejectedWith(RangeError, 'quux')", () => {
        shouldPass(() =>
          promise.should.not.be.rejectedWith(RangeError, 'quux')
        );
      });
      describe('.not.rejectedWith(RangeError, /quux/)', () => {
        shouldPass(() =>
      ...
      describe(".rejectedWith(RangeError, 'foo', custom)", () => {
        shouldPass(() =>
          promise.should.be.rejectedWith(RangeError, 'foo', custom)
        );
      });
      ...
      describe(".not.rejectedWith(RangeError, 'foo', custom)", () => {
        shouldFail({
          op: () =>
            promise.should.not.be.rejectedWith(RangeError, 'foo', custom),
          message: custom
        });
      });
      ...
      describe('.rejectedWith(RangeError, /bar/, custom)', () => {
        shouldPass(() =>
          promise.should.be.rejectedWith(RangeError, /bar/, custom)
        );
      });
      ...
      describe('.not.rejectedWith(RangeError, /bar/, custom)', () => {
        shouldFail({
          op: () =>
            promise.should.not.be.rejectedWith(RangeError, /bar/, custom),
          message: custom
        });
      });
      ...
      describe(".not.rejectedWith(TypeError, 'quux', custom)", () => {
        shouldPass(() =>
          promise.should.not.be.rejectedWith(TypeError, 'quux', custom)
        );
      });
      ...
      describe('.rejectedWith(RangeError, undefined, custom)', () => {
        shouldPass(() =>
          promise.should.be.rejectedWith(RangeError, undefined, custom)
        );
      });
      ...
      describe('.not.rejectedWith(RangeError, undefined, custom)', () => {
        shouldFail({
          op: () =>
            promise.should.not.be.rejectedWith(RangeError, undefined, custom),
          message: custom
        });
      });
      ...
      describe('.rejectedWith(TypeError, undefined, custom)', () => {
        shouldFail({
          op: () =>
            promise.should.be.rejectedWith(TypeError, undefined, custom),
          message: custom
        });
      });
      ...
      describe('.not.rejectedWith(TypeError, undefined, custom)', () => {
        shouldPass(() =>
          promise.should.not.be.rejectedWith(TypeError, undefined, custom)
        );
      });
    });
  ...
  describe('Using with non-thenables', () => {
    describe('A number', () => {
      ...
      it('should fail for .fulfilled', () => {
        expect(() => number.should.be.fulfilled).to.throw(
          TypeError,
          'not a thenable'
        );
      });
      it('should fail for .rejected', () => {
        expect(() => number.should.be.rejected).to.throw(
          TypeError,
          'not a thenable'
        );
      });
      it('should fail for .become', () => {
        expect(() => number.should.become(5)).to.throw(
          TypeError,
          'not a thenable'
        );
      });
      it('should fail for .eventually', () => {
        expect(() => number.should.eventually.equal(5)).to.throw(
          TypeError,
          'not a thenable'
        );
      });
  ...
  describe('Using together with other Chai as Promised asserters', () => {
    describe('.fulfilled.and.eventually.equal(42)', () => {
      shouldPass(() =>
        Promise.resolve(42).should.be.fulfilled.and.eventually.equal(42)
      );
    });
    ...
    describe('.rejected.and.eventually.equal(42)', () => {
      shouldPass(() =>
        Promise.reject(42).should.be.rejected.and.eventually.equal(42)
      );
    });
  ...
  describe('With promises that only become rejected later (GH-24)', () => {
    it('should wait for them', (done) => {
      ...
      rejectedLaterPromise.should.be
