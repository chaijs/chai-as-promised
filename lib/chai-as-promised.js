...
module.exports = (chai, utils) => {
    ...
    function getReasonName(reason) {
        const constructorName = checkError.getConstructorName(reason);
        const message = checkError.getMessage(reason);

        return reason instanceof Error ? reason.toString() : (constructorName instanceof String ? constructorName : message);
    }
