...
module.exports = (chai, utils) => {
  ...
  if (utils.checkError) checkError = utils.checkError;
  ...
  method("rejectedWith", function (errorLike, errMsgMatcher, message) {
    ...
    if (errorLike === undefined && errMsgMatcher === undefined && message === undefined) return this.rejected;

    if (message !== undefined) utils.flag(this, "message", message);
    ...
    if (errMsgMatcher instanceof RegExp) matcherRelation = "matching";
