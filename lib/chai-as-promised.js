(function (chaiAsPromised) {
    ...
    /* enricher: "then", "Q", or function (that, derivedPromise) {...} */
    chai.promisifyWith = function (enricher) {
        if (typeof enricher === "function") {
            chai.enrichPromise = enricher;
        }
        else if ((typeof enricher === "string") && chai.promisifyMethods[enricher]) {
            chai.enrichPromise = chai.promisifyMethods[enricher];
        } else {
            throw ("Invalid enricher");
        }
    };
