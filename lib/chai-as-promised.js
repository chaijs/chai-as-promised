(function () {
    ...
    function chaiAsPromised(chai, utils) {
        ...
        method("rejectedWith", function (Constructor, message) {
            console.log(Constructor, 'this is the constructor')
            console.log(typeof Constructor === "string", 'is it a string?')
            console.log(Constructor instanceof RegExp, 'is it an instanceof regexp')
