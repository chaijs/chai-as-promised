(function (chaiAsPromised) {
    ...
    chai.promiseEnrichers = {
        "then": function (that, derivedPromise) {
    ...
    chai.enrichPromiseWith = function (enricher) {
        if (typeof enricher === "function") {
            chai.enrichPromise = enricher;
        }
        else if ((typeof enricher === "string") && chai.promiseEnrichers[enricher]) {
            chai.enrichPromise = chai.promiseEnrichers[enricher];
        } else {
            throw ("Invalid enricher");
        }
    };

    chai.enrichPromiseWith("then");
