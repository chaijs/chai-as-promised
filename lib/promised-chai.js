            ...
            var onTransformedFulfilled = function () {
                if (!this.negate) {
                    this.assert(constructorIsGood(),
                                ...
                                " but it was rejected with a " + rejectionReason.name);

                    if (message) {
                        this.assert(messageIsGood(),
                                    "expected " + this.inspect + " to be rejected with an error matching " + message +
                                    " but got " + chai.inspect(rejectionReason.message));
                    }
                }
            }.bind(this);
            ...
            var onTransformedRejected = function () {
                if (this.negate) {
                    ...
                    if (message) {
                        this.assert(messageIsGood(),
                                    null,
                                    "expected " + this.inspect + " to be not be rejected with an error matching " +
                                    message);
                    }
                } else {
